...
const MovieCard = ({movie}) => {
  ...
  return (
    ...
    rounded-2xl hover:-translate-y-1 transition duration-300 w-66 '>
      <img onClick={()=>{Navigate(`/Movies/${movie._id}`);scrollTo(0,0)}} src={image_base_url+movie.backdrop_path} className='rounded-lg h-52 w-full object-cover object-right-bottom cursor-pointer ' alt="" />
