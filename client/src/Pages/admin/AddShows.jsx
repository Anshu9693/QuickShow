          ...
          {nowPlayingMovies.map((movie) => (
            ...
            >
              ...
              {selectedMovie === movie.id && (
                <div className="absolute top-2 right-2 flex justify-center items-center bg-primary h-6 w-6 rounded">
                  <CheckIcon className="w-4 h-4 text-white strockewidth={2.5}" />
                </div>
              )}
